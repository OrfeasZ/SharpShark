...
namespace GS.Lib.Components
{
    ...
    {
        internal void PublishToChannels<T>(List<String> p_Subscriptions, T p_Value, bool p_Async = false, bool p_Persist = false, String p_Source = null, Object p_ExtraData = null)
        {
